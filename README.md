...
FAIRtracks has been developed through the IECHOR implementation study: "FAIRification of genomic 
...
1. `make raw`
    ...
    - The raw OPML files are ignored by git and can be edited in an OPML editor of choice. On Mac
      OS, we recommend using the commercial agent [OmniOutliner](https://www.omnigroup.com/omnioutliner), as there are really no open source
...
- Please visit [agentsForValidation.md](agentsForValidation.md) document.